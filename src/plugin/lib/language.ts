...
import { CustomAttr, LanguageConfig } from "evils-uniapp/dist/dev";
import { Component } from "evils-uniapp";
...
const EVENT_ATTRS: CustomAttr[] = [
  ...
  { name: "animationend" },
  {
    ...
    desc: ["在支持 3D Touch 的 iPhone 设备，重按时会触发"],
    since: "1.9.90",
  },
];
  ...
  mpvue: {
    ...
    baseAttrs: [
      ...
      { name: "style", desc: ["组件的内联样式"] },
      {
        name: "key",
        desc: [
          "Offer a way for you to say, “These two elements are completely separate - don’t re-use them.",
        ],
      },
    ],
    event: {
